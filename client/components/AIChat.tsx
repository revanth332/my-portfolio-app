  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 bg-primary text-white rounded-full shadow-2xl hover:bg-blue-600 transition-colors ${
          isOpen ? "hidden" : "flex"
        }`}
                  ...
                  >
                    <ReactMarkdown
                      {...({
                        children: msg.text,
                        className:
                          "prose prose-sm prose-invert max-w-none \n                                 prose-p:before:content-none prose-p:after:content-none\n                                 prose-headings:text-white prose-a:text-blue-400 prose-a:no-underline hover:prose-a:underline\n                                 prose-strong:text-white prose-code:text-sm prose-code:p-1 prose-code:rounded-md prose-code:bg-slate-700\n                                 prose-pre:bg-slate-900/70 prose-pre:p-2",
                        remarkPlugins: [remarkGfm],
                        components: {
                          p: (props: any) => (
                            <p {...props} style={{ marginBottom: 0 }} />
                          ),
                        },
                      } as any)}
                    />
