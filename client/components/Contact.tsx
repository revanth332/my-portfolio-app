          ...
          >
            ...
            <div className="flex gap-4 mb-8">
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="flex-1 py-4 bg-slate-700/10 border border-slate-600/20 hover:bg-slate-700/20 text-white rounded-xl flex flex-col items-center justify-center gap-2 transition-all group"
              >
